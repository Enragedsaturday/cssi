# Ingest Queue — Full-Page BIRAC Worklist (S5 tiering / Phase-B target)

> The **full-page set**: every confirmed-miss that earns a standalone BIRAC page under **Decision 1 = TIER**, plus the **5 borderline-ingests** from Decision 2. A miss earns a page if its holding is **currently good law** OR it is **foundational/doctrine-defining** (even if later refined) OR it is a **famous teaching FOIL**. Default-to-PAGE governs every uncertain call. Cases here are **pending** until Phase-B confirms CL identity + current treatment at ingest (a page may be demoted later; none is silently dropped).
>
> **Size: 171** = 166 page-earning confirmed-misses (of the 170 remaining after 15 authored) + 5 borderline-ingests (O'Connor v. Ortega, Quon, Hudson v. Palmer, Salinas v. Texas, Heck v. Humphrey).
>
> **Ordering = batch plan.** Grouped by home doctrine into ingest batches A–O. Tier-reason: `good-law` (holding governs now) · `foundational` (doctrine-defining anchor, even if refined) · `foil` (overruled/limited but a famous case instructors name to teach the modern rule).
>
> Columns: Case · Holding / ratio · Proposed home(s) + role · Diag-class · Tier-reason. Borderline-ingests flagged **[BL]**.

## Batch A — Search threshold · REP · surveillance & tracking (13)
...
| Case | Holding / ratio | Proposed home(s) + role | Diag | Tier-reason |
|---|---|---|---|---|
| **Pembaur v. City of Cincinnati** | A single decision by a municipal policymaker can be 'official policy' creating Monell liability. | [[Section 1983 Liability and Qualified Immunity]] — Progeny (Monell line) | 2,3 | good-law |
| **Messerschmidt v. Millender** | Officers keep QI for executing a facially overbroad warrant where reliance on the magistrate's approval was objectively reasonable. | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[The Warrant Requirement]] | 1,7 | good-law |
| **Wilson v. Layne** | Bringing media into a home during warrant execution violates the 4A, but officers had QI (not clearly established). | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[The Warrant Requirement]] | 1,2 | good-law |
| **Hanlon v. Berger** | Per curiam companion to Wilson: a media ride-along during warrant execution violated the 4A; QI applied. | [[Section 1983 Liability and Qualified Immunity]] — Related | 2 | good-law |
| **Malley v. Briggs** | An officer who seeks a warrant on an affidavit so lacking in PC that no reasonable officer would rely on it loses QI. | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[The Warrant Requirement]] | 3 | good-law |
| **City of Canton v. Harris** | A municipality is liable under § 1983 for failure to train only where it amounts to deliberate indifference. | [[Section 1983 Liability and Qualified Immunity]] — Progeny (Monell line) | 3 | good-law |
| **Connick v. Thompson** | A single Brady violation without a pattern is generally insufficient for municipal failure-to-train liability. | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[Brady and Giglio]] | 2,3 | good-law |
| **Bivens v. Six Unknown Named Agents** | Implied a damages remedy directly under the 4A against federal officers (the federal analog to § 1983). | [[Section 1983 Liability and Qualified Immunity]] — Anchor (federal-officer liability) | 1,3 | foundational |
| **United States v. Classic** | Action 'under color of' state law for § 242 includes misuse of power held by virtue of state authority (color-of-law anchor). | [[Section 1983 Liability and Qualified Immunity]] — Anchor (color of law) | 3 | foundational |
| **Taylor v. Riojas** | Per curiam: QI denied where the violation (deplorable confinement) was so obvious no case on point was needed. | [[Section 1983 Liability and Qualified Immunity]] — Limiting | 6 | good-law |
| **Ashcroft v. al-Kidd** | A pretextual material-witness arrest did not violate clearly established law; subjective intent irrelevant to reasonableness. QI. | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[Seizure of the Person]] | 1,7 | good-law |
| **White v. Pauly** | Per curiam: QI where the law was not clearly established; reiterates the specificity requirement for force law. | [[Section 1983 Liability and Qualified Immunity]] — Progeny; [[Use of Force]] | 3,6 | good-law |
| **Heck v. Humphrey** **[BL]** | A § 1983 damages claim that would imply the invalidity of an outstanding conviction is barred until the conviction is set aside. | [[Section 1983 Liability and Qualified Immunity]] — Related (favorable-termination defense bar) | — | good-law |

## Batch N — Use of force · Brady/Giglio (12)

| Case | Holding / ratio | Proposed home(s) + role | Diag | Tier-reason |
|---|---|---|---|---|
| **Plumhoff v. Rickard** | Deadly force to end a dangerous high-speed chase was reasonable; officers also had QI. | [[Use of Force]] — Progeny; [[Section 1983 Liability and Qualified Immunity]] | 1,2 | good-law |
| **City and County of San Francisco v. Sheehan** | QI for force against an armed, mentally ill person; ADA-accommodation question left open. | [[Use of Force]] — Progeny; [[Section 1983 Liability and Qualified Immunity]] | 1,2 | good-law |
...
## Batch roll-up (Phase-B plan)

| Batch | Doctrine cluster | Count |
|---|---|---|
| A | Search threshold · REP · surveillance/tracking | 13 |
| B | Terry · stops · PC/RS · traffic · stop-and-ID | 15 |
| C | Seizure of person · arrest mechanics · arrest in home | 8 |
| D | Automobile · inventory · exigency · community caretaking | 15 |
| E | Search incident to arrest | 9 |
| F | Warrants: affidavit/particularity/magistrate/execution/K&A/securing | 16 |
| G | Consent · special needs/administrative/inspections · workplace REP | 11 |
| H | Exclusionary rule: origins/fruits/attenuation/good-faith | 10 |
| I | Standing · exclusionary limits · impeachment | 10 |
| J | Confessions: 5A incorporation/voluntariness/McNabb-Mallory | 10 |
| K | Miranda: custody/interrogation/warning adequacy/§1983 overlay | 13 |
| L | Miranda waiver/invocation · silence · 6A counsel · eyewitness ID | 14 |
| M | § 1983 · Monell · QI · Bivens · color of law | 13 |
| N | Use of force · Brady/Giglio | 12 |
| O | Common-law origins | 2 |
| **Total** | | **171** |

> Small batches C/E/O can be folded into their neighbors (C→B, E→D, O→A) to yield **~11 batches of ~15–18** for execution. Identity-confirm flags at ingest: **Case v. Montana** (possible 2025), and the name-collision pages (Henry 1959, Harris v. United States 1968, Harris v. New York 1971, Mathis 1968, Smith v. Illinois, Chapman 1961, Florida v. White, Davis 2011) per S4 · R5 year-suffix disambiguation.
