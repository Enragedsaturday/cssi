...
- **United States v. Moore-Bush (1st Cir. 2022) ([[Reading and Citing Cases#en-banc|en banc]])** — *illustrates the split.* The en banc First Circuit **unanimously reversed** the district court's suppression order and remanded with instructions to **deny** the motions to suppress — so the eight months of pole-camera evidence came **in** — even though the six judges divided **3–3** on the merits question whether sustained warrantless pole-camera surveillance of a home's curtilage is a Fourth Amendment "search" (one bloc reading *[[Carpenter v. United States|Carpenter]]*'s mosaic/aggregation theory to reach long-term targeted surveillance, the other finding no search at all). All six agreed the evidence was admissible under the ***Davis* good-faith exception** — the officers' reliance on then-binding circuit precedent (*Bucci*) — which required reversal regardless of the unresolved search question. **Binding in-circuit — 1st Cir.** · good. *(No standalone case page — named in prose with circuit.)* [opinion](https://www.courtlistener.com/opinion/6476395/united-states-v-moore-bush/)
...
flowchart TD
  ...
  D --> Q{"So intimately tied to home<br/>life that it is part of the home?"}
  ...
  O -->|"naked eye from public<br/>airspace / road"| N2["Not a search<br/>(Ciraolo · Riley · Dow Chemical)"]
  O -->|"sense-enhancing tech not in<br/>general public use → home interior"| S2["SEARCH (Kyllo)"]
```
