...
| *United States v. Tuggle*, 4 F.4th 505 (7th Cir. 2021) | (7th Cir. — persuasive, not binding; circuit split) Long-term warrantless pole-camera surveillance of a home's exterior and curtilage was not a search under existing doctrine because it captured only what was publicly visible — the *Ciraolo* "lawful vantage" principle applied to fixed cameras (court flagged the looming *Carpenter* aggregation problem). | [[Plain View Doctrine]] | [opinion](https://www.courtlistener.com/opinion/4899735/united-states-v-travis-tuggle/) |
