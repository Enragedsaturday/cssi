...
| *Chatrie v. United States*, 609 U.S. ___ (2026) | Acquiring **Google Location History (geofence)** data is a search — REP in the record of one's phone's location, even briefly and even when held by a third party; **applies/extends *Carpenter***, rejecting the opt-in/third-party rationale. PC/particularity of geofence warrants left open on remand. *(CL-confirm pending — slip-op sourced.)* | Binding — SCOTUS | Good (2026-06-30) | [slip op.](https://www.supremecourt.gov/opinions/25pdf/25-112_0am4.pdf) | [[Chatrie v. United States]] |
