...
**Burden of proof.** When a confession is challenged as involuntary, the prosecution bears the burden of proving voluntariness, and it must do so by at least a **preponderance of the evidence**. *Lego v. Twomey*, 404 U.S. 477, 489 (1972). (States may, as a matter of their own law, impose a higher standard.)
...
| *Missouri v. Seibert*, 542 U.S. 600 (2004) | The deliberate question-first/warn-later interrogation tactic targets Miranda's safeguards, but the plurality's concern with intentionally undermining a suspect's free choice sits alongside the due-process voluntariness inquiry into whether sustained interrogation overbore the will. NOTE: *Seibert* is a **Fifth Amendment / *Miranda*** question-first (two-step) case decided on *Miranda* prophylactic grounds, **not** a due-process voluntariness case. The plurality's concern with police intentionally undermining a suspect's free choice is offered here only as an instructive parallel to the due-process inquiry into whether sustained interrogation overbore the will; the two tests remain doctrinally distinct (Miranda prophylaxis vs. the freestanding Fourteenth Amendment due-process voluntariness test). | [[Miranda Waiver and Invocation]] | [opinion](https://www.courtlistener.com/opinion/137002/missouri-v-seibert/) |
