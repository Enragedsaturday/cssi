...
| --- | --- | --- | --- |
| *Brewer v. Williams*, 430 U.S. 387, 392-93, 399-400 (1977) | The detective's "Christian burial speech" is the textbook illustration of the functional equivalent of interrogation — words an officer should know are reasonably likely to elicit an incriminating response — even though the Court decided it on Sixth Amendment grounds (the *Innis* "functional equivalent" standard **announced** (not codified) the Fifth Amendment test for what counts as "interrogation" under *Miranda* — words or actions the police should know are reasonably likely to elicit an incriminating response). NOTE: *Brewer v. Williams* is a **Sixth Amendment deliberate-elicitation** case (the "Christian burial speech"); *Innis* itself distinguished *Brewer* rather than treating it as a *Miranda* functional-equivalent illustration, so the two should not be conflated (5A *Innis* functional-equivalent vs. 6A *Massiah/Brewer* deliberate-elicitation). | [[Sixth Amendment Right to Counsel]] | [opinion](https://www.courtlistener.com/opinion/109624/brewer-v-williams/) |
...
- **Public-safety exception is narrow.** *Quarles* permits un-Mirandized questions reasonably prompted by an immediate threat (the location of a hidden loaded gun); both the answer and the weapon are admissible. It is not a license for routine investigative questioning. The separate question of how *Miranda*-defective statements affect derivative evidence — physical fruits and later warned statements (the *Patane*/*Elstad* line) — is treated in [[Miranda Waiver and Invocation]].
...
- **"Constitutional rule" ≠ self-executing right (*Vega v. Tekoh*).** *Vega v. Tekoh*, 597 U.S. 134 (2022), recharacterized *Miranda* as a **prophylactic rule** that is **not itself a self-executing constitutional right**, so a bare *Miranda* violation (admission of an unwarned statement) does not support a 42 U.S.C. § 1983 damages claim against the officer. This materially qualifies *Dickerson*'s "constitutional rule" framing: *Miranda* remains a constitutionally based rule courts must enforce by exclusion, but its violation is not, standing alone, a deprivation of a constitutional right actionable in damages.
...
```mermaid
flowchart TD
    A[Statement by suspect] --> B{Custody?<br/>objective: arrest-equivalent restraint}
    B -- No --> N[No warnings required]
    B -- Yes --> C{Interrogation?<br/>express OR functional equivalent — Innis}
    C -- No --> N
