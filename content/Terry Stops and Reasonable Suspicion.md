...
status: verified
related: ["[[Seizure of the Person]]", "[[Traffic Stops]]", "[[Consent Searches]]", "[[Plain View Doctrine]]", "[[Use of Force]]", "[[Fourth Amendment Analysis Checklist]]"]
---
...
| *United States v. Vinton*, 594 F.3d 14 (D.C. Cir. 2010) | *Michigan v. Long*'s protective vehicle frisk survives *Arizona v. Gant*: even where *Gant* bars a search-incident, an officer with RAS that a stopped occupant is dangerous and may access a weapon may conduct a *Terry* frisk of the passenger compartment. | [[Traffic Stops]] | [opinion](https://www.courtlistener.com/opinion/187527/united-states-v-vinton/) |
...
flowchart TD
  ...
  S["<b>Terry stop</b><br/>RAS criminal activity afoot<br/>brief investigative detention"]
  F["Protective frisk<br/>RAS armed & dangerous<br/>weapons pat-down"]
  A["Arrest<br/>probable cause"]
  E -->|"facts rise to RAS"| S
  S -->|"separate RAS:<br/>armed & dangerous"| F
  S -->|"facts rise to PC"| A
