...
| *Kansas v. Glover*, 589 U.S. 376 (2020) | Reasonable suspicion may rest on a **common-sense inference** (registered owner with a revoked license is likely the driver). | SCOTUS — binding | [link](https://www.courtlistener.com/opinion/9226123/kansas-v-glover/) |
...
| *United States v. Sharpe*, 470 U.S. 675 (1985) | Duration is a **diligence** test (confirm or dispel suspicion quickly) — no rigid time limit. | SCOTUS — binding | [link](https://www.courtlistener.com/opinion/9429956/united-states-v-sharpe/) |
| *Illinois v. Caballes*, 543 U.S. 405 (2005) | A **dog sniff** during a lawful stop is **not a search**; the only defect is added time. | SCOTUS — binding | [link](https://www.courtlistener.com/opinion/9434728/illinois-v-caballes/) |
...
| *Berkemer v. McCarty*, 468 U.S. 420 (1984) | *(5A / Miranda cross-doctrine)* An ordinary traffic stop is *Terry*-like and is **not** Miranda "custody." | SCOTUS — binding | [link](https://www.courtlistener.com/opinion/9429728/berkemer-v-mccarty/) |
...
```mermaid
flowchart TD
  A["Objective traffic/criminal violation?<br/>(RAS or PC — pretext irrelevant · <i>Whren</i>;<br/>reasonable mistake of law OK · <i>Heien</i>;<br/>RAS may rest on common-sense inference · <i>Glover</i>)"] -->|No| X["Unlawful stop<br/>no random/standardless stops · <i>Prouse</i>"]
  A -->|Yes| M["Lawful stop begins —<br/>work the MISSION · <i>Rodriguez</i><br/>license · reg · warrant checks · ticket"]
  M --> C["Control & safety:<br/>order driver+passengers out (no suspicion) · <i>Mimms</i>/<i>Wilson</i>;<br/>frisk a person on RAS armed &amp; dangerous · <i>Johnson</i>;<br/>protective frisk of compartment on RAS of weapon · <i>Long</i>/<i>Vinton</i>"]
  M --> P{"Prolong for unrelated<br/>investigation? (e.g. dog sniff —<br/>sniff ≠ search · <i>Caballes</i>)"}
...
- *Kansas v. Glover*, 589 U.S. 376 (2020) — https://www.courtlistener.com/opinion/9226123/kansas-v-glover/
...
- *United States v. Sharpe*, 470 U.S. 675 (1985) — https://www.courtlistener.com/opinion/9429956/united-states-v-sharpe/
- *Illinois v. Caballes*, 543 U.S. 405 (2005) — https://www.courtlistener.com/opinion/9434728/illinois-v-caballes/
...
- *Berkemer v. McCarty*, 468 U.S. 420 (1984) — https://www.courtlistener.com/opinion/9429728/berkemer-v-mccarty/ *(5A / Miranda cross-doctrine clarifier — traffic stop is not custody; not a 4A holding)*
