---
title: "Use of Force — Graham v. Connor"
aliases:
  - "Graham v Connor"
topic: Use of Force — Graham v. Connor (objective reasonableness)
type: doctrine
jurisdiction: Federal (U.S. Const. amend. IV); SCOTUS baseline
status: verified
related: ["[[Seizure of the Person]]", "[[Fourth Amendment Framework]]", "[[Three Golden Rules]]", "[[Fourth Amendment Analysis Checklist]]"]
---
...
```mermaid
flowchart TD
  A["Force used during a SEIZURE<br/>of a free person (Graham)"] --> B["Objective reasonableness —<br/>reasonable officer on scene,<br/>NOT 20/20 hindsight; intent irrelevant"]
  B --> C["3 named factors (non-exclusive):<br/>severity of crime · immediate threat ·<br/>active resistance / flight"]
