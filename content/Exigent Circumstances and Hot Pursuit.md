...
```mermaid
flowchart TD
  A[Warrantless entry claimed?] --> B{Genuine exigency<br/>not police-created?}
  B -- No --> X[Suppress: King bar]
  B -- Yes --> C{Type}
  C --> D[Hot pursuit<br/>Hayden / Santana]
  C --> E[Evidence destruction<br/>McNeely totality]
