...
## Flashcards
- State the two-element automobile-exception test.::(1) The vehicle is readily mobile, and (2) the officer has probable cause to believe it contains contraband or evidence — then a warrantless search is permitted "without more" (*Labron*, 518 U.S. at 940; *Morley*).
- How far does the search reach?::Every part of the vehicle and every container within it where the object of the search may be found — scope tracks probable cause (*Ross*, 456 U.S. at 825; *Acevedo*).
- Must the search happen at the roadside?::No — it may be conducted later at the station, after impoundment, even days afterward; immobilization does not end the justification (*Chambers*; *Johns* — three days later).
- What are *Carney*'s two rationales?::Ready mobility, and a reduced expectation of privacy stemming from the vehicle's pervasive regulation as a licensed motor vehicle (471 U.S. at 392–93).
- Can the exception reach a car parked in a home's driveway?::No — *Collins*: the automobile exception does not permit warrantless entry of a home or its curtilage to search a vehicle parked there.
- Does PC to search the car reach a passenger's purse?::Yes, if it is "capable of concealing the object of the search" — a non-suspect passenger's ownership is no shield (*Wyoming v. Houghton*, 526 U.S. at 307). It does not reach the passenger's body/person (see [[Search Incident to Arrest]]).
