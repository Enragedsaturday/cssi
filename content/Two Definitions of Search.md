...
```mermaid
flowchart TD
  Q["Government conduct — is it a SEARCH?<br/>(either theory suffices)"]
  Q --> T["TRESPASS theory<br/>Jones / Jardines"]
  Q --> P["PRIVACY theory<br/>Katz (Harlan concurrence)"]
  T --> T1["1 · Physical intrusion on a<br/>constitutionally protected area<br/>(person · house · paper · effect)<br/>2 · Intent to obtain information"]
  P --> P1["1 · Subjective expectation of privacy<br/>2 · One society accepts as reasonable"]
  T1 --> S["= a SEARCH<br/>(warrant or recognized exception required)"]
  P1 --> S
```
