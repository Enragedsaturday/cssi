...
status: verified
related: ["[[Emergency Aid]]", "[[Seizure of the Person]]", "[[Special Needs and Administrative Searches]]", "[[Search Incident to Arrest]]", "[[Automobile Exception]]"]
---
...
flowchart TD
  ...
  Q -->|"VEHICLE / roadside / impound"| V["Caretaking handling reasonable if genuinely<br/>noncriminal + objective basis (<i>Cady</i>)<br/>inventory under STANDARDIZED procedures,<br/>not a pretext (<i>Opperman</i> · <i>Bertine</i>)<br/>→ <b>Special Needs</b> / <b>Search Incident to Arrest</b>"]
