...
This page spans two related but distinct lines of authority. Both share one root — *reasonableness without a traditional warrant on probable cause* — but they diverge on **what** is searched and **what substitutes** for the warrant:

- **"Special needs"** — searches of **persons** serving a government interest *beyond the normal need for law enforcement*, where the warrant/probable-cause requirement is impracticable. The phrase comes from Justice Blackmun's *T.L.O.* concurrence ("special needs, beyond the normal need for law enforcement," 469 U.S. at 351), **not** the majority — students often miscredit it. When such a need exists, the court drops warrant + PC and instead **balances** the government interest against the privacy intrusion, which can sustain suspicionless testing. Contexts: schools (*T.L.O.*), employee/safety drug testing (*Skinner*, *Von Raab*), and probation/parole (*Griffin*, *Knights*, *Samson*). The *Edmond* purpose gate still governs: the primary purpose must not be ordinary crime control.
- **"Administrative"** — inspections of **premises** (and closely regulated industries) to enforce a *regulatory scheme* (housing, fire, and safety codes), not to gather criminal evidence. The default rule is **not** "no warrant" but a warrant of a special kind: an **area warrant** issued on neutral, legislatively fixed criteria rather than individualized PC (*Camara*; extended to commercial premises in *See*; reaffirmed for OSHA inspections in *Marshall v. Barlow's*). A **narrow** closely-regulated-industry exception (*New York v. Burger*) dispenses with the warrant entirely when its three-part test is met.
...
| *See v. City of Seattle*, 387 U.S. 541 (1967) | *Camara*'s administrative-warrant rule extends to commercial premises: a business owner may insist on a warrant before an inspection of non-public areas. | SCOTUS — binding | [opinion](https://www.courtlistener.com/opinion/107474/see-v-city-of-seattle/) |
| *Marshall v. Barlow's, Inc.*, 436 U.S. 307 (1978) | OSHA may not conduct warrantless inspections of business premises; an administrative inspection warrant is required, subject to the closely-regulated carve-out. | SCOTUS — binding | [opinion](https://www.courtlistener.com/opinion/109866/marshall-v-barlows-inc/) |
...
- **The Camara → See → Barlow's arc.** *Camara*'s area-warrant rule (above) is not limited to homes: its companion *See* extends it to commercial premises, and *Marshall v. Barlow's* applies it to OSHA workplace inspections. The area warrant is easier to get than a criminal warrant, but a warrant is still the default for an unconsented administrative entry.
- **Burger's closely-regulated-industry test (the warrant *substitute*).** A warrantless inspection of a closely regulated business is reasonable only if all three are met (482 U.S. at 702-03): (1) a **substantial government interest** informs the regulatory scheme; (2) warrantless inspection is **necessary** to further that scheme; and (3) the scheme is a **constitutionally adequate substitute for a warrant** — it gives the owner notice and limits the inspecting officers' discretion in time, place, and scope. This is a narrow carve-out (junkyards/vehicle dismantlers, liquor, firearms, mines), not a license to inspect any business at will.
...
- **Treating the closely-regulated exception as the general admin-inspection rule.** *Barlow's* and *Burger* make the warrantless-inspection carve-out **narrow** — most businesses are not "closely regulated," so the default remains an administrative (area) warrant under *Camara*/*See*. Do not assume a regulatory interest alone authorizes a warrantless entry.
- **Crediting the "special needs" label to the T.L.O. majority.** The "special needs, beyond the normal need for law enforcement" formulation is Justice Blackmun's *concurrence* (469 U.S. at 351); the majority decided *T.L.O.* on a straight reasonableness rationale.
...
```mermaid
flowchart TD
    A[Suspicionless / no-PC search] --> B{Primary purpose = ordinary crime control?}
...
- [See v. City of Seattle](https://www.courtlistener.com/opinion/107474/see-v-city-of-seattle/)
- [Marshall v. Barlow's, Inc.](https://www.courtlistener.com/opinion/109866/marshall-v-barlows-inc/)
