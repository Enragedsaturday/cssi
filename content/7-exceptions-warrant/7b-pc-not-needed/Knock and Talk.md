...
```mermaid
flowchart TD
    A[Approach front door<br/>implied license] --> B[Knock, wait briefly,<br/>seek consent]
    B --> C{Within license?}
    C -->|Yes: ordinary visitor path<br/>and purpose| D[OK: consensual encounter]
