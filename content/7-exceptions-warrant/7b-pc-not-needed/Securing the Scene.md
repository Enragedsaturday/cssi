...
| *Segura v. United States*, 468 U.S. 796 (1984) | Securing/occupying premises pending a warrant does not itself require suppression; evidence later seized under a warrant built on wholly independent information is admissible despite a prior illegal entry. | SCOTUS — binding | [opinion](https://www.courtlistener.com/opinion/111259/segura-v-united-states/) |
...
These cases are treated in full elsewhere but bear directly on securing the scene, framed here for that doctrine.

| Case | Relevance to securing the scene | Primary treatment | CourtListener |
| --- | --- | --- | --- |
| *Payton v. New York*, 445 U.S. 573 (1980) | The entry predicate for the suspicionless *Buie* sweep: an arrest warrant plus reason to believe the suspect is home authorizes entry into his own dwelling, and that lawful in-home arrest is what triggers the protective-sweep authority. | [[Arrest in the Home]] | [opinion](https://www.courtlistener.com/opinion/110235/payton-v-new-york/) |
| *Brigham City v. Stuart*, 547 U.S. 398 (2006) | Officers who make a lawful warrantless entry under the emergency-aid/exigency exception are lawfully on the premises and may then secure the scene with a *Buie* protective sweep; the sweep authority rides on the lawfulness of the entry, not on an arrest alone. | [[Community Caretaking and Emergency Aid]] · [[Exigent Circumstances and Hot Pursuit]] | [opinion](https://www.courtlistener.com/opinion/145654/brigham-city-v-stuart/) |
| *Kentucky v. King*, 563 U.S. 452 (2011) | Police may secure a residence and act on an exigency to prevent destruction of evidence even where their own lawful conduct (a knock-and-announce) precipitated it, so long as they did not threaten to violate the Fourth Amendment; complements the *McArthur* freeze as the exigency basis for holding/entering premises pending a warrant. | [[Arrest in the Home]] · [[Exigent Circumstances and Hot Pursuit]] · [[Knock and Talk]] | [opinion](https://www.courtlistener.com/opinion/216733/kentucky-v-king/) |
| *Murray v. United States*, 487 U.S. 533 (1988) | Independent-source companion to *Segura*: where officers secure premises (a freeze) and observe evidence during an unlawful entry, that evidence is still admissible if later seized under a warrant supported by genuinely independent information not derived from the entry. | [[The Exclusionary Rule]] | [opinion](https://www.courtlistener.com/opinion/112136/murray-v-united-states/) |
| *Michigan v. Long*, 463 U.S. 1032 (1983) | The vehicular analogue of the *Buie* protective sweep: on specific, articulable facts that a suspect is dangerous and may gain control of weapons, officers may conduct a limited protective search of the passenger compartment to secure the scene of a stop. | [[Traffic Stops]] | [opinion](https://www.courtlistener.com/opinion/111020/michigan-v-long/) |
...
- **Entry predicate in a third party's home (*Steagald*).** The *Summers*/*Buie* authorities can be exercised only once officers are lawfully inside. Entering a third party's home to arrest the subject of an arrest warrant requires a separate search warrant absent exigency or consent (*Steagald*) — so where the premises belong to someone other than the arrestee, the search-warrant predicate, not the arrest warrant, governs whether officers may be there to detain occupants or sweep.
- **Burden and standard of review.** Because a protective sweep and a *McArthur* freeze are warrantless intrusions, the government bears the burden of justifying them — articulable facts of danger for a beyond-adjoining-spaces *Buie* sweep, and probable cause plus reasonable temporariness for the freeze. On a suppression appeal, the trial court's historical fact findings are reviewed for clear error and the ultimate reasonableness determination de novo.
...
```mermaid
flowchart TD
  A[Lawful search/arrest at premises] --> B{What to secure?}
  B -->|People| C[Detain occupants<br/>Summers]
  C --> D[Cuff for search duration<br/>Muehler]
  C --> E{In immediate vicinity?<br/>Bailey}
  E -->|No| F[Need RS or PC<br/>Terry]
  B -->|Space| G[Protective sweep<br/>Buie]
  G --> H[Adjoining spaces:<br/>no suspicion]
  G --> I[Beyond: reasonable<br/>articulable suspicion]
  B -->|Premises pending warrant| J[Freeze entry, brief<br/>McArthur]
```

## Recent developments & subsequent treatment
Recent federal appellate law has pushed *Buie*'s officer-safety rationale outward from its in-home-arrest core. Circuit decisions are **persuasive, not binding**, on federal courts elsewhere; no SCOTUS case is pending on the scope of the protective sweep, so the controlling baseline remains *Buie*, *Summers*, *Muehler*, and *Bailey*.

- **United States v. August (5th Cir. 2025)** — Persuasive, **not binding** (Fifth Circuit). Articulates the four-part protective-sweep test and expressly extends it to curtilage (the opinion brackets "[or curtilage]" into prong (1)) and to a NON-arrest, investigatory entry — the backyard sweep occurred before August was arrested. Extends *Buie*'s officer-safety rationale beyond the in-home-arrest setting. ⚖ Circuit split (treat as a doctrinal-extension flag — *Buie* outside arrest/curtilage — rather than an opinion-recognized split). "A protective sweep is lawful if: (1) the government agents have a legitimate law enforcement purpose for being in the house [or curtilage]; (2) the sweep is supported by a reasonable, articulable suspicion that the area to be swept harbors an individual posing a danger to those on the scene; (3) the sweep is no more than a cursory inspection of those spaces where a person may be found; and (4) the sweep lasts no longer than is necessary to dispel the reasonable suspicion of danger and lasts no longer than the police are justified in remaining on the premises." *United States v. August*, 136 F.4th 595, 599 (5th Cir. 2025). [opinion](https://www.courtlistener.com/opinion/10574922/united-states-v-august/).
