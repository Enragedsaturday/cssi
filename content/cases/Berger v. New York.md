...
## Background
Berger was convicted of conspiracy to bribe a state official, based on recordings obtained under eavesdrop orders issued pursuant to New York's permissive eavesdropping statute (§ 813-a). The statute allowed an *ex parte* order, on "reasonable ground to believe that evidence of crime" might be obtained, authorizing 60-day installation of recording devices with possible extensions. Berger challenged the statute as authorizing general, exploratory electronic searches without Fourth Amendment particularity.

## Issue
Whether New York's permissive eavesdropping statute satisfies the Fourth Amendment, or whether its breadth and lack of particularity render electronic surveillance under it unreasonable.
