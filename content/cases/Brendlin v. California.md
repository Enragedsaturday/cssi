...
## Issue
Whether a passenger in a vehicle is "seized" by a traffic stop, so that he has standing to challenge the constitutionality of the stop.
...
## Conclusion
A passenger is seized by a traffic stop and may challenge it; the judgment was reversed and the case remanded.
