...
A small movement from the front door to reach the occupant stays within that geographic limit: "approaching Walker's vehicle parked inside of his open-sided carport, instead of going to his front door, did not exceed the geographic limit on the knock and talk exception. A 'small departure from the front door . . . when seeking to contact the occupants' is permissible." — 799 F.3d at 1364 (quoting *United States v. Taylor*, 458 F.3d 1201, 1205 (11th Cir. 2006)). ^pin-1364 The court also held that a pre-dawn knock and talk is reasonable on these circumstances and that an early-morning knock and talk "is not considered a search," so it requires no exigent circumstances. — *Id.* (& n.1). ^pin-1364a
