...
- **Materiality standard superseded by** [[United States v. Bagley]] (1985): Agurs had set different materiality tests for its three situations (knowing use of perjury; specific request; no/general request); *Bagley* adopted a single "reasonable probability" standard for all undisclosed *Brady*/*Giglio* evidence, absorbing Agurs's no-request "reasonable doubt that did not otherwise exist" formula. The **surviving** holding — that the disclosure duty attaches to obviously exculpatory evidence even without a request — remains good law and is built into [[Brady v. Maryland]]/[[Kyles v. Whitley]] doctrine. Agurs's situation 1 traces to the knowing-perjury line of [[Mooney v. Holohan]] and [[Giglio v. United States]].
