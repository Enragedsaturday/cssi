...
The Court refused to recognize a "firearm exception" that would permit a stop and frisk on a gun tip that failed standard reliability testing: "We decline to adopt this position." — *Id.* ^pin-272a
