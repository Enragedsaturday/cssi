...
## Conclusion
The convictions were affirmed: the suppression, though it occurred, was not material and so worked no *Brady* violation. *Brady* materiality is measured against the entire trial record, not in isolation.
