...
Role-based, circuit/state only. Two threads: **circuit/state applications of the exceptions**, and the **good-faith exception carrying the load in the digital arena**. Note the antecedent **search** question for geofence / location-history data is now **resolved by the Supreme Court** — *[[Chatrie v. United States|Chatrie]]* (2026) holds acquiring geofence Location History **is** a search — so in the geofence cases below it is the **good-faith exception** (reasonable reliance on a pre-*Chatrie* warrant), not the absence of a search, that carries admissibility; the warrant's probable cause/particularity was left open on remand.
...
- **Good faith in the digital arena — geofence (search question now RESOLVED by SCOTUS) · *United States v. Chatrie*** `4th Cir. → superseded by SCOTUS` The 4th Cir. panel (Richardson, J., joined by Wilkinson, J.; Wynn, J., [[Common Legal Terms#dissenting-opinion|dissenting]]) had held that obtaining a short (~2-hour) window of Google Location History was **not** a search (voluntarily shared, third-party doctrine, *[[Carpenter v. United States|Carpenter]]* not extended); on rehearing en banc the court fractured 7–7 on whether a search occurred, 136 F.4th 100 (2025). The Supreme Court **reversed course on the search question** in *[[Chatrie v. United States|Chatrie v. United States]]*, 609 U.S. ___ (2026): acquiring geofence Location History **is** a search. Because the geofence warrant predated that ruling, the live remedial questions are the warrant's **probable cause/particularity** (remanded) and, failing that, the **good-faith exception**. *(See [[Chatrie v. United States]]; CL-confirm pending.)* [slip op.](https://www.supremecourt.gov/opinions/25pdf/25-112_0am4.pdf)
- **Good faith in the digital arena — geofence · *United States v. Smith* (5th Cir. 2024)** `Binding in-circuit — 5th Cir.` Obtaining Google Location History via a geofence **is** a Fourth Amendment search — the search-question result **now confirmed** by *[[Chatrie v. United States|Chatrie]]* (2026). *Smith*'s further holding that geofence warrants are "modern-day general warrants" and categorically unconstitutional was **not** adopted by the Supreme Court (it feeds the remanded PC/particularity question). Even so, **the evidence was not suppressed** under the *Leon* good-faith exception given the novelty of the technology: "we uphold the district court's determination that suppression was unwarranted under the good-faith exception." 110 F.4th at 838. *(No standalone case page — annotate-only; circuit named.)* [opinion](https://www.courtlistener.com/opinion/10036119/united-states-v-smith/)
...
```mermaid
flowchart TD
  A["Evidence obtained via a 4A violation<br/>(+ its fruits — <i>Wong Sun</i> / <i>Silverthorne</i>)"] --> S{"Standing?<br/>Was it YOUR OWN reasonable<br/>expectation of privacy? — <i>Rakas</i>"}
  S -->|No| ADM["ADMITTED — no suppression"]
  S -->|Yes| EX{"Does an exception<br/>break the chain?"}
  EX -->|"Independent source<br/><i>Silverthorne · Murray · Segura</i>"| ADM
  EX -->|"Inevitable discovery<br/><i>Nix</i> (preponderance)"| ADM
  EX -->|"Attenuation<br/><i>Wong Sun · Brown · Strieff · Ceccolini</i>"| ADM
  EX -->|"Good faith<br/><i>Leon · Sheppard · Krull · Davis (2011)</i>"| ADM
  EX -->|"Wrong forum / cost > benefit<br/><i>Hudson · Janis · Calandra · Lopez-Mendoza</i>"| ADM
  EX -->|"None applies"| SUP["SUPPRESS from case-in-chief<br/>evidence + fruits<br/>(still usable to impeach the<br/>defendant — <i>Walder · Havens</i>)"]
```
...
- *Chatrie v. United States*, 609 U.S. ___ (2026) (No. 25-112) — geofence Location History IS a search; PC/particularity remanded — slip op.: https://www.supremecourt.gov/opinions/25pdf/25-112_0am4.pdf *(see [[Chatrie v. United States]]; CL-confirm pending — CL object 10881683 corrupted)*. Decision below: *United States v. Chatrie*, 136 F.4th 100 (4th Cir. 2025) (en banc) — https://www.courtlistener.com/opinion/10443725/united-states-v-okello-chatrie/.
